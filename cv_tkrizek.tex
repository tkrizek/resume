...
\ecvitem[5pt]{First name / Surname}{Tom Křížek}
\ecvitem[5pt]{Telephone}{+420 xxx xxx xxx}
\ecvitem[5pt]{E-mail}{\href{mailto:tkrizek@mailbox.org}{tkrizek@mailbox.org}}
\ecvitem[5pt]{Date of birth}{dd. mm. yyyy}
\ecvitem[5pt]{Address}{Poličanská 1487\newline190 16 Prague 9\newline Czech Republic}
\ecvitem[5pt]{\href{https://github.com/tkrizek}{GitHub}}{\url{https://github.com/tkrizek}}


\ecvsection{Work Experience}

\ecvitem{2022--present}{
\textbf{Quality Assurance Engineer}\newline
\textit{Internet Systems Consortium (ISC)}
\begin{itemize}
  \item Running, extending and improving BIND tests.
  \item Maintaining, tweaking and evolving the CI environment.
  \item Troubleshooting BIND issues and writing code reproducing them.
  \item Approving product releases for delivery.
\end{itemize}
\textit{Python, C, Lua, git, DNS, Linux, Bash, AWS}
\newline}
